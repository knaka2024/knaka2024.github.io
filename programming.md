...
- プログラミング競技で使用する盤面データはまだご提供できておりません。 **「お試し盤面データの生成」** を元に複数の盤面データを選定して**盤面データをまとめたテキストファイル** の形で提供させていただく予定です。準備ができましたらこちらのサイトで開示いたします。
