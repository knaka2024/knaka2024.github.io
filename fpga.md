...
- 競技用盤面に関する実行結果を `minesweeper_result.xlsx` に記載いただきまして、das”at”sig-sldm.org より、ADC 事務局あてご連絡をいただければと思います。（”at”は@に変換してください）。受領しましたら、事務局メンバーより返信させていただきます。どうぞよろしくお願いいたします。
